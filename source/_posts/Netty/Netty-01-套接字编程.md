...
![](./Netty-01-套接字编程/image-20230518214107228.png)

作为一名开发，我怎么使用TCP协议在两个应用之间通信呢，可能有两个方法
...
![](Netty-01-套接字编程/image-20230518222908047.png)

### 4.3 Java怎么进行网络编程的

怎么调用socket相关方法呢

#### 4.3.1 Java针对OS的fd进行封装
...
![](Netty-01-套接字编程/image-20230518234650181.png)
...
![](Netty-01-套接字编程/image-20230518235609869.png)

#### 4.4.3 多路复用器

不同的平台有不同的实现，以mac为例，提供的最优方案是kqueue

### 4.5 Java怎么去支持这个非阻塞方式的
...
![](Netty-01-套接字编程/image-20230519001214882.png)
...
![](Netty-01-套接字编程/image-20230519095748203.png)
