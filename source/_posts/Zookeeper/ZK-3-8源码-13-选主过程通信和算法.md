...
前面已经看过了{% post_link Zookeeper/ZK-3-8源码-11-QuorumCnxManager组件 QCM组件 %}和{% post_link Zookeeper/ZK-3-8源码-12-FastLeaderElection组件 FLE组件 %}。
...
还是沿用上面3.1的例子，这个地方我就不贴源码了，源码看{% post_link Zookeeper/ZK-3-8源码-12-FastLeaderElection组件 上一章节 %}。
